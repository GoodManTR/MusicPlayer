...
interface trackListFragmentInterface {
    fun trackListSongRecylerViewListClickHandler(v: View?, position: Int)
    fun getTrackListSongCover(albumid: Long) : Bitmap?

}

class TrackListSongAdapter( private val trackListFragmentInterface: trackListFragmentInterface,var  onAlbumSongSelect: onTracklistSongSelect) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is VHItem) {
            ...
            var image = trackListFragmentInterface.getTrackListSongCover(currentItem.song_album_id);
            ...
            holder.itemView.setOnClickListener{
                ...
                onAlbumSongSelect.onTrackListSelect(tracklistSongAdapterData[position - 1])
            }
    ...
    override fun getItemCount(): Int {
        return tracklistSongAdapterData.size + 1
    }
    ...
    private fun getItem(position: Int): SongModel {
        if (position == 0)
            return tracklistSongAdapterData[position + 1]
        else
            return tracklistSongAdapterData[position - 1]
    }
    ...
    internal inner class VHItem(itemView: View?) : RecyclerView.ViewHolder(itemView!!), View.OnClickListener {
        ...
        override fun onClick(v: View?) {
            ...
            trackListFragmentInterface.trackListSongRecylerViewListClickHandler(v, position)
    ...
    companion object {
        ...
        var tracklistSongAdapterData: ArrayList<SongModel> = ArrayList()
    }
